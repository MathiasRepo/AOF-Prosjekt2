...
const DEFAULT_LOGOS = [
  { id: 1, name: "Oslo Kommune", logo: "https://via.placeholder.com/150x80?text=Oslo+Kommune" },
  { id: 2, name: "Innovasjon Norge", logo: "https://via.placeholder.com/150x80?text=Innovasjon+Norge" },
  { id: 3, name: "DNB", logo: "https://via.placeholder.com/150x80?text=DNB" },
  { id: 4, name: "Telenor", logo: "https://via.placeholder.com/150x80?text=Telenor" },
  { id: 5, name: "Equinor", logo: "https://via.placeholder.com/150x80?text=Equinor" },
  { id: 6, name: "NTNU", logo: "https://via.placeholder.com/150x80?text=NTNU" },
  { id: 7, name: "Sintef", logo: "https://via.placeholder.com/150x80?text=Sintef" },
  { id: 8, name: "Sparebank1", logo: "https://via.placeholder.com/150x80?text=Sparebank1" },
  { id: 9, name: "Vipps", logo: "https://via.placeholder.com/150x80?text=Vipps" }
];
...
export const LogoCarousel = ({ 
    ...
    const intervals = logoColumns.map((column, columnIndex) => {
      return setInterval(() => {
        setActiveIndices((prev) => {
          ...
          newIndices[columnIndex] = (newIndices[columnIndex] + 1) % column.length;
          return newIndices;
        });
  ...
  return (
    <section id="samarbeidspartnere" className="relative pt-8 pb-32 overflow-hidden z-10">
      {/* Background elements removed - now shared in App.jsx */}
      
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 font-museo">Våre Samarbeidspartnere</h2>
          <p className="text-hub-blue-light max-w-2xl mx-auto opacity-90">
            Vi er stolte av å samarbeide med disse fantastiske selskapene og organisasjonene.
          </p>
        </div>
